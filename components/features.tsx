        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,theme(colors.gray.200),theme(colors.indigo.200),theme(colors.gray.50),theme(colors.indigo.300),theme(colors.gray.200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
              We are here for all types of businesses
            </h2>
            <p className="text-lg text-indigo-200/65">
             From Ecommerce to hardware, to consumables; Fundryft got you covered. Apply now and get a feel of what we have packed
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200">
                 Data Room Setup for Investor
              </h3>
              <p className="text-indigo-200/65"> A complete and professionally organized data room designed to facilitate investor due diligence and showcase your startup's
                potential.
              </p>
            </article>
            <article>
              ...
              <p className="text-indigo-200/65">We provide an exclusive U.S. incorporation service for startups looking to expand
                internationally. This service is priced separately at $400.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                We give you a soft introduction to potential partner investors who may be willing to invest in your product
              </p>
            </article>
            <article>
              <svg
            ...
            <article>
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200">
                Document Preparations and organizations
              </h3>
              <p className="text-indigo-200/65">
                We cover everything from your pitch deck and executive summary to ﬁnancial projections and critical due diligence documents
              </p>
            </article>
            <article>
              <svg
